...
HD_PWD='C:/Users/user/Desktop/term/LCD_LAB_term/LCD_LAB_TERM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log car_dashboard_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source car_dashboard_top.tcl -notrace
