...
HD_PWD='C:/Users/user/Desktop/term/LCD_LAB_term/LCD_LAB_TERM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log car_dashboard_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source car_dashboard_top.tcl
